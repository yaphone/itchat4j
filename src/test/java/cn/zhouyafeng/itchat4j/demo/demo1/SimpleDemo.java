...
public class SimpleDemo implements IMsgHandlerFace {
	...
	public String picMsgHandle(BaseMsg msg) {
		final String fileName = new SimpleDateFormat("yyyy-MM-dd-HH-mm-ss").format(new Date());// 这里使用收到图片的时间作为文件名
		final String picPath = "D://itchat4j/pic" + File.separator + fileName + ".jpg"; // 调用此方法来保存图片
	...
	public String verifyAddFriendMsgHandle(BaseMsg msg) {
		...
		final RecommendInfo recommendInfo = msg.getRecommendInfo();
		final String nickName = recommendInfo.getNickName();
		final String province = recommendInfo.getProvince();
		final String city = recommendInfo.getCity();
		final String text = "你好，来自" + province + city + "的" + nickName + "， 欢迎添加我为好友！";
		return text;
	}
	...
	public String mediaMsgHandle(BaseMsg msg) {
		...
		final String filePath = "D://itchat4j/file" + File.separator + fileName; // 这里是需要保存收到的文件路径，文件可以是任何格式如PDF，WORD，EXCEL等。
