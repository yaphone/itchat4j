...
public interface WechatInterface {
	 ...
	 * @return
	 */
	boolean wxInit(Account account);
...
//	Map<String, String> syncStatus(Account account);
	 ...
	 */
	void wxSyncMessage(Account account , MessageHandler messageHandler);
	 ...
	 */
	void wxGetContact(Account account);
	 ...
	 */
	void wxBatchGetContact(Account account);
